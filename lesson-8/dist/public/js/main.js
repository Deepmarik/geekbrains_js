...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"app\", function() { return app; });\n/* harmony import */ var _components_cart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/cart */ \"./src/public/js/components/cart.js\");\n/* harmony import */ var _components_product__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/product */ \"./src/public/js/components/product.js\");\n/* harmony import */ var _components_cartproduct__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/cartproduct */ \"./src/public/js/components/cartproduct.js\");\n/* harmony import */ var _components_search__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/search */ \"./src/public/js/components/search.js\");\n/* harmony import */ var _components_error__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/error */ \"./src/public/js/components/error.js\");\n\n\n\n\n\nconst app = {\n  el: '#app',\n  components: {\n    cart: _components_cart__WEBPACK_IMPORTED_MODULE_0__[\"cart\"],\n    products: _components_product__WEBPACK_IMPORTED_MODULE_1__[\"products\"],\n    cartproducts: _components_cartproduct__WEBPACK_IMPORTED_MODULE_2__[\"cartproducts\"],\n    error: _components_error__WEBPACK_IMPORTED_MODULE_4__[\"error\"],\n    'search': _components_search__WEBPACK_IMPORTED_MODULE_3__[\"search\"]\n  },\n  methods: {\n    getJson(url) {\n      return fetch(url).then(result => result.json()).catch(error => this.$refs.error.setText(error));\n    },\n\n    postJson(url, data) {\n      return fetch(url, {\n        method: 'POST',\n        headers: {\n          \"Content-Type\": \"application/json\"\n        },\n        body: JSON.stringify(data)\n      }).then(result => result.json()).catch(error => this.$refs.error.setText(error));\n    },\n\n    putJson(url, data) {\n      return fetch(url, {\n        method: 'PUT',\n        headers: {\n          \"Content-Type\": \"application/json\"\n        },\n        body: JSON.stringify(data)\n      }).then(result => result.json()).catch(error => this.$refs.error.setText(error));\n    },\n\n    deleteJson(url) {\n      return fetch(url, {\n        method: 'DELETE',\n        headers: {\n          \"Content-Type\": \"application/json\"\n        }\n      }).then(result => result.json()).catch(error => this.$refs.error.setText(error));\n    }\n\n  }\n};\n\n//# sourceURL=webpack:///./src/public/js/app.js?");

/***/ }),

/***/ "./src/public/js/components/cart.js":
/*!******************************************!*\
  !*** ./src/public/js/components/cart.js ***!
  \******************************************/
